    ...
    return (
        <section className="flex flex-col items-center">
            ...
            <a
                href="/resume.pdf"
                download={true}
                className=" mb-[1.8rem] sm:mb-[6.8rem] text-[#656565] dark:text-white p-1 px-2 rounded border border-[1.9px] border-[#656565] cursor-pointer hover:bg-[#B87650] hover:text-gray-200 active:bg-[#A8653F]"
            >
                Resume
            </a>
